...
//	 The function creates a HKCR registry key and sets the specified registry value name.
...
//	 The function opens a HKCR registry key and gets the data for the specified registry value name.
